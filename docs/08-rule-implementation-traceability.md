...
| 玩家生命、流血、伤口、挫伤、暴露与镇痛 | DEC-026、DEC-031、DEC-034、DEC-035 | `combat.player`、`combat.escape`、`medical.painkiller`、`scene.postActionBleedingDamage` | `src/core/condition/`、`src/core/combat/` | `src/core/condition/condition.test.ts`、医院条件与战斗医疗集成测试 | 部分实现 | 已实现类型化伤口、待处理感染暴露及战斗绷带／止痛药；感染进展、其他医疗物品、场景非战斗和电梯中枢医疗尚未实现。 |
...
| 快捷栏 | DEC-007、DEC-016、DEC-034 | `backpack.quickSlotCount`、`medical.bandage`、`medical.painkiller`、医院快捷栏资格与战斗绑定 | `src/core/quick-slot/`、`src/core/combat/`、医院快捷栏及战斗内容目录 | 核心快捷栏、命令严格性和ItemState移除测试，医院战斗医疗及场景写回集成测试 | 已实现战斗物品使用 | 已实现实际单件实例、堆叠抽取、放回、槽间转移，以及战斗绷带／止痛药的显式具体命令、原子消耗与不自动补充；场景非战斗、电梯中枢、其他消耗品和UI使用尚未实现。 |
| 感染护工单敌人CTB战斗 | DEC-006、DEC-026、DEC-031、DEC-032、DEC-034、DEC-035、DEC-036、DEC-037 | `combat.*`、`medical.bandage`、`medical.painkiller` | `src/core/combat/`、`src/core/scene-combat/`、`src/content/hospital-v0.1/combat/` | 核心敌人目录、命令与换算测试，医院战斗医疗及场景遭遇集成测试 | 部分实现 | 已完成严格恢复、敌人循环、运行时内容绑定、连续CTB Effect链、既有五种玩家行动、快捷栏绷带／止痛药、逃跑锁定与同点优先、节点自动触发、持久重入、终局场景时间和强制返程写回；战利品、样本箱、多目标及其他医疗上下文尚未实现。 |
