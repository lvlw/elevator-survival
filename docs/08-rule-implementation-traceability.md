...
| 感染护工单敌人CTB战斗 | DEC-006、DEC-026、DEC-031、DEC-032、DEC-035、DEC-036、DEC-037 | `combat.*` | `src/core/combat/`、`src/content/hospital-v0.1/combat/` | 核心敌人目录测试、医院战斗时间轴与风险集成测试 | 部分实现 | 已完成首次／重入快照、CTB调度、基础攻击、蓄力击打、防御、临时攻击、抓挠、扑咬、风险和战斗终局；逃跑、快捷医疗、场景时间写回和节点触发尚未实现。 |
